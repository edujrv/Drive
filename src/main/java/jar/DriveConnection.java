...
/**
 * This class has the drive "service" object, it should never be changed
 */
public class DriveConnection {
    ...
    public static void initialize() throws IOException, GeneralSecurityException {
        if (!hasConnection) {
            ...
            DriveConnection.service = new Drive.Builder(HTTP_TRANSPORT, JSON_FACTORY, getCredentials(HTTP_TRANSPORT))
